...
'''
Movie - Up
Description Source - https://www.imdb.com/title/tt1049413/plotsummary,
                     user: Jwelch5742
'''
up = media.Movie("Up",
...
inside_out = media.Movie("Inside Out",
                         "When a young girl named Riley is uprooted from her "
                         "Midwestern lifestyle and moves to the busy and "
                         "chaotic San Francisco, her emotions; Anger, "
                         "Sadness, Disgust, Fear, and (her most "
...
'''
Movie - Megamind
Description Source - https://www.imdb.com/title/tt1001526/plotsummary,
                     user: IMDB editors
'''
megamind = media.Movie("Megamind",
                       "After super-villain Megamind kills his good-guy "
                       "nemesis, Metro Man, he becomes bored since there"
